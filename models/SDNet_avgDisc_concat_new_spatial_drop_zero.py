...
from layers_new import up_conv2d, spatial_drop, res_block_bottleneck
...
class SDNet:
    def __init__(self, num_layers, batch_size, target_shape, num_res=1, pool5=True, tag='default', fix_bn=False,
        ...
        """
        self.name = 'SDNet_avgDisc_concat_spatialdrop_zero_res{}_{}'.format(num_res, tag)
    ...
    def net(self, imgs, reuse=None, train=True):
        ...
        pixel_drop, drop_mask = spatial_drop(enc_im, [3, 3])
