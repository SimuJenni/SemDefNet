...
from AlexNet_avgDisc_concat_noBN_3 import AlexNet
from layers_new import up_conv2d_new, pixel_dropout, res_block_bottleneck
...
class SDNet:
    def __init__(self, num_layers, batch_size, target_shape, num_res=1, pool5=True, tag='default', fix_bn=False,
        ...
        """
        self.name = 'SDNet_avgDisc_concat_new3_res{}_{}'.format(num_res, tag)
